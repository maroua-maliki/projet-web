    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="module.php" class="sidebar-link collapsed has-dropdown" ">
                        <i class="bi bi-journals"></i>
                        <span>Modules</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="listeEtudiant.php" class="sidebar-link collapsed has-dropdown" >
             ...
             <li class="sidebar-item">
                  <a href="indexnote.php" class="sidebar-link collapsed has-dropdown" >
                ...
                <li class="sidebar-item">
                    <a href="personnel.php" class="sidebar-link">
