...
<body>
        ...
        <div class="sidebar" id="side_nav">
            ...
            <div class="sidebar-heading">
                ...
                <li class=""><a href="#" class="text-decoration-none px-3 py-3 d-block"><i class="fas fa-user fa-2x fa-sm text-gray-300"></i>
                        Profile</a></li>
                <li class=""><a href="#" class="text-decoration-none px-3 py-3 d-block"><i class="fas fa-users fa-2x fa-sm text-gray-300"></i>
                        Personnel</a></li>
    ...
    ?>
    <a href="ajouter.php" class="btn btn-dark mb-3">Ajouter Nouveau</a>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="modifier.php?id=<?php echo $row["CNE"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
              <a href="supprimer.php?id=<?php echo $row["CNE"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
